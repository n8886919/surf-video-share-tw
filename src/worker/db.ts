...
const schemaStatements = [
  ...
  `CREATE TABLE IF NOT EXISTS forecast_snapshots (
    ...
    provider TEXT NOT NULL,
    model TEXT NOT NULL,
    snapshot_kind TEXT DEFAULT 'forecast' NOT NULL,
    ...
    total_swell_height REAL,
    total_swell_direction REAL,
    total_swell_period REAL,
    total_swell_peak_period REAL,
    swell_height REAL,
    swell_direction REAL,
    swell_period REAL,
    swell_peak_period REAL,
    secondary_swell_height REAL,
    secondary_swell_direction REAL,
    secondary_swell_period REAL,
