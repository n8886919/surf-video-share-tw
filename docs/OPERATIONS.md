...
- Each Open-Meteo request still asks for 168 hourly ECMWF WAM forecast hours for immutable provenance. Public matching accepts Taipei day offsets 0–4 at 05:00–17:00: offsets 0–2 require both ECMWF and CWA, while offsets 3–4 are explicitly ECMWF-only. CWA remains independently bounded to verified 0–72-hour leads. The fixed CWA `O00400` tide fields are stored only for 烏石港 and 雙獅; the Worker nulls that tide enrichment for the six later spots until their official tide locations are verified.
