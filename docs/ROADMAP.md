...
Validate the owner-requested Baishawan addition with one natural contract-v5 ingestion across the twenty active spots after its coordinated rollout. After that check, infrastructure and feature scope are frozen until real users validate the core find/watch/upload path.
