...
describe("spot seed", () => {
  it("keeps the twenty approved spots active with exact coordinates and provenance", () => {
    ...
    expect(activeSpots).toHaveLength(20);
    ...
    expect(bySlug.baishawan).toMatchObject({ nameZh: "白沙灣", region: "North", latitude: "25.284457106306995", longitude: "121.52043233444185" });
